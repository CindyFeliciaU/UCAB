...
public class DriverMapActivity3 extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
       ...
       /* // Add a marker in Sydney and move the camera
        LatLng latLng = new LatLng(25,23);
        MarkerOptions markerOptions =new MarkerOptions().position(latLng).title("l").snippet("e");
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults){
        if( requestCode == ACCESS_LOCATION_REQUEST_CODE){
            if( grantResults.length>0 && grantResults[0] ==PackageManager.PERMISSION_GRANTED){
                ...
                //Show dialog that the permission is not granted
